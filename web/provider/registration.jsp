<%-- 
    ...
    Created on : Apr 28, 2015, 11:20:05 AM
    Author     : cyber
--%>
					...
					<div class="parallax-pattern-overlay">
						<div class="container text-center" style="height:600px;padding-top:170px;">
							<a href="#"><img id="site-title" class=" wow fadeInDown" wow-data-delay="0.0s" wow-data-duration="0.9s" src="../MyResume/img/2.png" alt=""/></a>
                                                        <h2 class="intro"><a href="../MyResume/index.html">Provider Registration</a></h2>
						</div>
					</div>
				</div>
			</div>	
		...
		<div class="container">
			<div class="heading text-center">				
				<h2>Registration</h2>
                                ...
                                <form name="uregister" action="reg_action.jsp" class="contactForm">
<html>
    <body>
        <table border="0" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><textarea name="jkj" rows="4" cols="20" class="form-control" required="1"></textarea></td>
                    </tr>
                    <tr>
                        <td>Phone Number</td>
                        <td><input type="number" name="t3" value=""  class="form-control" required="1"/></td>
                    </tr>
                     <tr>
                     ...
                     <tr>
                        <td>Email id</td>
                        <td><input type="email" name="hj" value="" class="form-control"  required="1"/></td>
                    </tr>                       
                     ...
                     <tr>
                        <td>Password</td>
                        <td><input type="password" name="fhj"  class="form-control" required="1" /></td>
                    </tr>
                    <tr>
