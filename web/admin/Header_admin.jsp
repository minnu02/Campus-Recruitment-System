<%-- 
    ...
    Created on : Feb 2, 2017, 5:13:58 PM
    Author     : Vishnu S
--%>
					...
					<div class="parallax-pattern-overlay">
						<div class="container text-center" style="height:600px;padding-top:170px;">
							<a href="#"><img id="site-title" class=" wow fadeInDown" wow-data-delay="0.0s" wow-data-duration="0.9s" src="../MyResume/img/2.png" alt=""/></a>
                                                        <h2 class="intro"><a href="../MyResume/index.html">ADMIN</a></h2>
						</div>
					</div>
				</div>
			</div>	
										...
										<div class="navbar-collapse collapse">
											<ul class="nav navbar-nav">
												<li class="menuItem "><a href="home.jsp" style="color: blue;">Home Page</a></li>
                                                                                                <li class="menuItem"><a href="Adddeletejobprovider.jsp" style="color: blue;">Provider</a></li>
                                                                                                    <li class="menuItem"><a href="deletejobseeker.jsp" style="color: blue;">Seeker</a></li>
                                                                                                    <li class="menuItem"><a href="viewapplication.jsp" style="color: blue;">Application</a></li>
                                                                                                    <li class="menuItem"><a href="viewvacancy.jsp" style="color: blue;">Vacancy</a></li>
