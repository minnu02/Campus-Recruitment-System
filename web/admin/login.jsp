<%-- 
    Document   : login
    Created on : Apr 28, 2015, 2:22:53 PM
    Author     : cyber
--%>
<%-- 
			...
			<div class="heading text-center">				
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="a1" value=""  class="form-control" placeholder="UserName" required="1" autofocus="1"/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><font size="5">Password</font></td>
                        <td><input type="password" name="a2" value="" class="form-control" placeholder="password" required="1"/></td>
                        <td></td>
                    </tr>
                    <tr>
