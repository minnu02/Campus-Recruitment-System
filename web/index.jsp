<%-- 
    Document   : index
    Created on : Apr 28, 2015, 11:00:49 AM
    Author     : cyber
--%>
					...
					<div class="parallax-pattern-overlay">
						<div class="container text-center" style="height:600px;padding-top:170px;">
							<a href="#"><img id="site-title" class=" wow fadeInDown" wow-data-delay="0.0s" wow-data-duration="0.9s" src="MyResume/img/2.png" alt=""/></a>
                                                        <h2 class="intro"><a href="MyResume/index.html">CAMPUS RECRUITMENT SYSTEM</a></h2>
						</div>
					</div>
				</div>
			</div>	
									...
									<div class="navArea">
										<div class="navbar-collapse collapse">
											<ul class="nav navbar-nav">
                                                                                            <li class="menuItem"><a href="admin/login.jsp" style="color: blue;">Admin</a></li>
                                                                                            <li class="menuItem"><a href="provider/Login.jsp" style="color: blue;">Company</a></li>
                                                                                            <li class="menuItem"><a href="seeker/Login.jsp" style="color: blue;">Student</a></li>
